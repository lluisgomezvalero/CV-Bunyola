...
function ensureStyles(){
  ...
  style.textContent=`
    ...
    @media(max-width:768px){
      ...
      /* Cualquier modal se comporta como una pantalla nativa por encima de la tab bar. */
      ...
      /* El resumen de partido de jugadora es una pantalla completa con scroll propio. */
      ...
      /* Pequeña transición de pantalla, similar a navegación nativa. */
