...
function install(){
  const wait=()=>{
    ...
    console.info('[TeamLoadDashboard] ACWR-4 cargado: RPE medio, sesiones y tendencia activos.');
  };
  wait();
}
