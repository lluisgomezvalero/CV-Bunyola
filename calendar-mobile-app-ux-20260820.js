...
function ensureStyles(){
  ...
  style.textContent=`
    @media(max-width:760px){
      #view-calendar .gcal-toolbar{display:grid!important;grid-template-columns:minmax(0,1fr) auto!important;align-items:center!important;gap:.55rem!important;margin-bottom:.7rem!important;padding:0!important}
      ...
      #view-calendar .gcal-toolbar-right{display:flex!important;align-items:center!important;gap:.3rem!important}
      #view-calendar #gcal-select-month{display:none!important}
      #view-calendar #gcal-btn-today{height:36px!important;min-width:50px!important;padding:0 .65rem!important;border-radius:10px!important;font-size:.68rem!important;font-weight:800!important}
      #view-calendar #gcal-btn-prev,#view-calendar #gcal-btn-next{width:36px!important;height:36px!important;min-width:36px!important;padding:0!important;border-radius:10px!important;display:grid!important;place-items:center!important}
      #view-calendar #gcal-month-title{min-width:0!important;margin:0 .1rem!important;font-size:1rem!important;line-height:1.05!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
      #view-calendar #btn-add-event{width:38px!important;height:38px!important;min-width:38px!important;padding:0!important;border-radius:11px!important;font-size:0!important;display:grid!important;place-items:center!important;box-shadow:none!important}
      #view-calendar #btn-add-event svg{width:17px!important;height:17px!important}
      #view-calendar .gcal-weekdays-header,#view-calendar .gcal-month-grid{display:none!important}
      #view-calendar #gcal-agenda-view.cal-app-agenda{display:flex!important;flex-direction:column!important;gap:.72rem!important;padding:0 0 calc(84px + env(safe-area-inset-bottom))!important}
      #view-calendar .cal-app-day{display:block!important}
      #view-calendar .cal-app-day-head{display:flex!important;align-items:center!important;gap:.55rem!important;margin:0 0 .38rem .15rem!important}
      #view-calendar .cal-app-day-number{display:grid!important;place-items:center!important;width:32px!important;height:32px!important;flex:0 0 32px!important;border-radius:9px!important;background:#f1f5f9!important;color:#172033!important;font-family:var(--font-heading)!important;font-size:.78rem!important;font-weight:850!important}
      #view-calendar .cal-app-day-head>div:last-child{min-width:0!important}
      #view-calendar .cal-app-day-head strong{display:block!important;text-transform:capitalize!important;font-size:.72rem!important;line-height:1.05!important;color:#293548!important}
      #view-calendar .cal-app-day-head span{display:block!important;margin-top:.08rem!important;font-size:.54rem!important;color:#96a0ae!important;text-transform:uppercase!important;letter-spacing:.035em!important}
      #view-calendar .cal-app-day-events{display:flex!important;flex-direction:column!important;gap:.34rem!important}
      #view-calendar .cal-app-event{appearance:none!important;width:100%!important;display:grid!important;grid-template-columns:auto minmax(0,1fr) auto!important;align-items:center!important;gap:.58rem!important;padding:.62rem .66rem!important;border:1px solid #e6ebf1!important;border-left-width:3px!important;border-radius:13px!important;background:rgba(255,255,255,.97)!important;text-align:left!important;color:inherit!important;box-shadow:0 3px 12px rgba(15,23,42,.025)!important;font:inherit!important}
      ...
      #view-calendar .cal-app-visual{width:38px!important;height:38px!important;flex:0 0 38px!important;display:flex!important;align-items:center!important;justify-content:center!important;border:1px solid #edf1f5!important;border-radius:10px!important;background:#fff!important;overflow:hidden!important}
      #view-calendar .cal-app-visual>img{width:32px!important;height:32px!important;object-fit:contain!important}
      #view-calendar .cal-app-icon svg{width:17px!important;height:17px!important;color:#6d7b8d!important}
      #view-calendar .cal-app-match-visual{width:68px!important;gap:2px!important;padding:2px!important}
      #view-calendar .cal-app-match-visual img{width:25px!important;height:25px!important;object-fit:contain!important}
      #view-calendar .cal-app-match-visual span{font-size:.42rem!important;font-weight:850!important;color:#a0a9b5!important}
      #view-calendar .cal-app-event-copy{min-width:0!important}
      #view-calendar .cal-app-event-top{display:flex!important;align-items:center!important;gap:.4rem!important;margin-bottom:.12rem!important}
      #view-calendar .cal-app-kind{display:inline-flex!important;align-items:center!important;min-height:18px!important;padding:.14rem .32rem!important;border-radius:6px!important;background:#f4f6f8!important;color:#6f7b8a!important;font-size:.48rem!important;font-weight:850!important;text-transform:uppercase!important;letter-spacing:.025em!important}
      ...
      #view-calendar .cal-app-time{font-size:.55rem!important;font-weight:750!important;color:#8a96a5!important;font-variant-numeric:tabular-nums!important}
      #view-calendar .cal-app-event-copy>strong{display:block!important;min-width:0!important;font-family:var(--font-heading)!important;font-size:.76rem!important;line-height:1.12!important;color:#202b3c!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
      #view-calendar .cal-app-event-copy>small{display:flex!important;align-items:center!important;gap:.2rem!important;min-width:0!important;margin-top:.14rem!important;font-size:.55rem!important;color:#8995a5!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
      #view-calendar .cal-app-event-copy>small svg{width:10px!important;height:10px!important;flex:0 0 10px!important}
      #view-calendar .cal-app-arrow{width:15px!important;height:15px!important;color:#a5afbb!important}
      #view-calendar .cal-app-empty{display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;gap:.3rem!important;min-height:150px!important;padding:1.2rem!important;border:1px dashed #dce3ea!important;border-radius:15px!important;background:rgba(255,255,255,.72)!important;text-align:center!important;color:#8490a0!important}
      #view-calendar .cal-app-empty svg{width:22px!important;height:22px!important}
      #view-calendar .cal-app-empty strong{font-size:.78rem!important;color:#465366!important}
      #view-calendar .cal-app-empty span{font-size:.6rem!important}
    }
  `;
